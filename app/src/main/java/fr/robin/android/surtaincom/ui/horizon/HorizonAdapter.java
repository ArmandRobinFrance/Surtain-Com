...
public class HorizonAdapter extends ArrayAdapter<Article> {

    public HorizonAdapter(Context context, List<Article> articles) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
            if(convertView == null){
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.fragment_horizon_row,parent, false);
            }
            //
            HorizonViewHolder viewHolder = (HorizonViewHolder) convertView.getTag();
            if(viewHolder == null){
                viewHolder = new HorizonViewHolder();
