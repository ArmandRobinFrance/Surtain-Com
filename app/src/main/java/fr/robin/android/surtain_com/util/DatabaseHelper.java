...
import fr.robin.android.surtain_com.models.dao.AdministrationDAO;
import fr.robin.android.surtain_com.models.dao.ArticleDAO;
...
public class DatabaseHelper {
    ...
    public void insertArticle(Article data){
        ...
        fr.robin.android.surtain_com.models.bo.Article entity = new fr.robin.android.surtain_com.models.bo.Article(1,data.getTitle(),data.getContent(),data.getCategorie());
        dao.insert(entity);
    }
     ...
     * Tous les articles
     */
    public List<fr.robin.android.surtain_com.models.bo.Article> selectAllArticle() {
        ArticleDAO dao = new ArticleDAO(this);
        return dao.getAll();
    }
     ...
     */
    public List<fr.robin.android.surtain_com.models.bo.Article> selectArticle(int categorie) {
        ArticleDAO dao = new ArticleDAO(this);
